...
class MyFileReader {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Set<String>> locationsFromNER = lemmatizeData(
                getResultsFromAlgorithm("/home/arseny/Downloads/ner_loc.txt"),
                wordLemmatization,
                stopWords
        );
        System.out.println(getLevenshteinDistance(lemmatizeData(mappedDataSet.getLocation(), wordLemmatization, stopWords),locationsFromNER));
        Map<String, Set<String>> dateTimeFromNER = lemmatizeData(
                getResultsFromAlgorithm("/home/arseny/Downloads/ner_dt.txt"),
                wordLemmatization,
                stopWords
        );
        System.out.println(getLevenshteinDistance(lemmatizeData(mappedDataSet.getTime(), wordLemmatization, stopWords),dateTimeFromNER));
    }
}
